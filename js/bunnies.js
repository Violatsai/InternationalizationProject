...
function endGame()
{
	...
	var verb = _('Number of bunnies splattered');
	
	switch (randomMessage)
	{
		case 1:
			verb = _('Number of bunnies eviscerated');
			break;
		case 2:
			verb = _('Number of bunnies mutilated');
			break;
		case 3:
			verb = _('Number of bunnies massacred');
			break;
		case 4:
			verb = _('Number of bunnies butchered');
			break;
	}
	
	message.innerHTML = verb + ": <p>" + scoreP.firstChild.nodeValue + "</p>";
	message.innerHTML += ('<input class="button" id="shotgunButton" type="button" value="' + _('reload your shotgun!') + '" onClick="reinitialise()">');
	message.innerHTML += ('<input class="button" id="stopButton" type="button" value="' + _('make the killing stop!') + '" onClick="stop()">');
...
function stop()
{
	...
	closing.innerHTML += '<p class="closingMessage">' + _('The bunnies of the world thank you for your pacifism. Happy Easter!') + '</p>';
...
function levelUp()
{
	...
	levelMessage.innerHTML = _('Level ') + level;
